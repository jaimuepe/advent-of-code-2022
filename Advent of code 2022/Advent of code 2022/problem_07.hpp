...
namespace aoc2022
{
    ...
    class problem_07 final : public problem
    {
    public:
        ...
        B_IMPL()
        {
            ...
            const long long available_space = B_DISK_SIZE - dir_size(root);
            const long long space_required = B_UPDATE_SIZE - available_space;
